...
def onmainload():
    global hiredatelabel, toolbarpanel, closedetailbtn, lastnamelabel, listview1, aboutbuildlabel, detaillabel, mainform, detailform, editbtn, tab1, abouttitle, salaryedit, db, searchlabel, searchedit, salarylabel, statslabel, aboutform, aboutcopyright, detailwindowbtn, lastnameedit, searchpanel, helpmenu, aboutitem, timer1, viewmenu, currentid, firstnameedit, deletebtn, emailedit, aboutdesclabel, savebtn, aboutversionlabel, searchbtn, exititem, cancelbtn, addbtn, mainmenu, hiredateedit, detailitem, deptcombobox, statsgrid, filemenu, refreshbtn, deptlabel, emaillabel, activecheck, closeaboutbtn, detailimage, editframe, infotabs, tab2, statusbar, firstnamelabel
    initdb()
...
editframe = PGroupBox(parent=tab1)
editframe.left = 5
editframe.top = 25
editframe.width = 850
