...
def onmainload():
    global searchlabel, lastnameedit, detaillabel, searchpanel, emaillabel, tab1, lastnamelabel, detailwindowbtn, searchbtn, refreshbtn, listview1, viewmenu, savebtn, editbtn, cancelbtn, exititem, mainmenu, helpmenu, salarylabel, infotabs, deptcombobox, addbtn, mainform, closedetailbtn, firstnameedit, statusbar, aboutitem, db, searchedit, detailform, statslabel, abouttitle, statsgrid, currentid, aboutversionlabel, timer1, hiredateedit, detailitem, aboutform, editframe, aboutbuildlabel, detailimage, toolbarpanel, aboutdesclabel, deletebtn, activecheck, aboutcopyright, deptlabel, filemenu, salaryedit, tab2, closeaboutbtn, firstnamelabel, hiredatelabel, emailedit
    initdb()
...
infotabs = PTABCOROL(parent=mainform)
infotabs.top = 395
infotabs.left = 10
infotabs.width = 870
infotabs.height = 150
