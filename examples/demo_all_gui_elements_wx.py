...
def onload():
    global radio1, checkresult, button1, radio2, edit1, selectgroup, check2, tab1, progressbar1, radioresult, track1, grid1, richedit1, mainform, bottompanel, radio3, listlabel, testspassed, progresslabel, radiolabel, statusbar, filemenu, tabs, tab2, label1, exititem, basicgroup, mainmenu, combo1, timelabel, check1, timer1, aboutitem, list1, tracklabel, tab3, helpmenu, listview1, combolabel
