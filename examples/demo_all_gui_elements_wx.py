...
def onload():
    global list1, selectgroup, radioresult, tab3, helpmenu, timelabel, mainmenu, check2, statusbar, tab1, radio1, listlabel, aboutitem, mainform, grid1, tracklabel, exititem, richedit1, radio2, label1, filemenu, listview1, bottompanel, combo1, combolabel, basicgroup, testspassed, radiolabel, edit1, check1, progresslabel, tab2, progressbar1, checkresult, radio3, track1, timer1, button1, tabs
